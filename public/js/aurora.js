import { Renderer, Program, Triangle, Mesh, Color } from 'https://cdn.jsdelivr.net/npm/ogl@0.0.117/src/index.mjs';
...
export class Aurora {
  ...
  update(t) {
    this.animateId = requestAnimationFrame(this.update);
    const timeToUse = this.options.time ?? (t * 0.01);
    this.program.uniforms.uTime.value = timeToUse * this.options.speed * 0.1;
  ...
  destroy() {
    ...
    if (this.renderer && this.container) {
      const gl = this.renderer.gl;
      if (gl.canvas.parentNode === this.container) {
