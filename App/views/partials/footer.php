    ...
    <div class="footer-container">
        ...
        <div class="footer-newsletter">
            ...
            <form>
                ...
                <button type="submit" class="shimmer-btn" style="width: 100%; display: block; text-align: center; padding: 0.75rem 1.5rem; font-size: 0.95rem; font-weight: 600; letter-spacing: 0.03em; cursor: pointer; border: none;">Subscribe Now</button>
            </form>
        </div>
    </div>
...
<canvas id="starfield-bg" style="position: fixed; top: 0; left: 0; width: 100vw; height: 100vh; z-index: -999; pointer-events: none;"></canvas>
