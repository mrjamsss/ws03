...
<section
    ...
    <div class="container mx-auto text-center z-10">
        <h2 class="h2-style text-white mb-4">Find Your Dream Job</h2>
        <form method="GET" action="/listings/search" class="mb-4 block mx-5 md:mx-auto">
            ...
            <input
                ...
                class="w-full md:w-auto mb-2 px-4 py-2 focus:outline-none" />
            <button
                class="w-full md:w-auto shadow-sm text-base font-medium shimmer-btn px-4 py-2 focus:outline-none">
